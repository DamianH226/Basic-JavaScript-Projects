...
const Calculator = {
    //this 1s displays 0 on the screen
    Display_Value: '0',
...
function Input_Decimal (dot) {
    ...
    // we are saying that if the Di splay_Value does not contain a decimal point
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null) {
        ...
        //if operator exists, property lookup 1s performed for the operator
